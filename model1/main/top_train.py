...
def main():
    ...
    MODEL_PATH = f"./classification_model/model1/model/top.pt"
    CONFMAT_PATH = f"./classification_model/model1/result/confmat/top_train.jpg"
    GRAPH_PATH = f"./classification_model/model1/result/graph/top_train.jpg"
    TEXT_PATH = f"./classification_model/model1/result/text/top_train.txt"
    acc = train_all_model(DEVICE, DATA_PATH, MODEL_PATH, CONFMAT_PATH, GRAPH_PATH, TEXT_PATH)
    print("-"*50)
    print(f"Accuracy of top model: {acc:.2f}%")
