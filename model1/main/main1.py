...
train_dir = Path("C:/Users/elvio/Documents/folder_vio/Coding/College/UNDERGRADUATE-PROJECT/dataset/my_dataset/model1/train")  # train folders
test_dir = Path("C:/Users/elvio/Documents/folder_vio/Coding/College/UNDERGRADUATE-PROJECT/dataset/my_dataset/model1/train")  # test folders
...
#%%
print(trainset.classes)  # List of class names
print(len(trainset.classes))  # Number of classes
#%%
print([label for _, label in trainset])  # Inspect labels
#%%
unique_labels = set(label for _, label in trainset)
...
plt.savefig("/classification_model/model1/result/with_real_dataset.png")
plt.show()
# %%
