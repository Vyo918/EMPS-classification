...
def main():
    ...
    MODEL_PATH = f"./classification_model/model1/model/big_category(97.18).pt"
    CONFMAT_PATH = f"./classification_model/model1/result/confmat/big_category_load.jpg"
    MISSCLASSIFIED_PATH = f"./classification_model/model1/result/missclassified/big_category_load/"
    final_acc = load(DEVICE, DATA_PATH, MODEL_PATH, CONFMAT_PATH, MISSCLASSIFIED_PATH)
    print(f"big_category model accuracy: {final_acc:.2f}%")
