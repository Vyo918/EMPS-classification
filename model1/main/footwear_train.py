...
def main():
    print(f"Training footwear model:\n")
    DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
    DATA_PATH = f"./dataset/my_dataset/model1/improved/footwear/"
    MODEL_PATH = f"./classification_model/model1/model/footwear.pt"
    CONFMAT_PATH = f"./classification_model/model1/result/confmat/footwear_train.jpg"
    GRAPH_PATH = f"./classification_model/model1/result/graph/footwear_train.jpg"
    TEXT_PATH = f"./classification_model/model1/result/text/footwear_train.txt"
    acc = train_all_model(DEVICE, DATA_PATH, MODEL_PATH, CONFMAT_PATH, GRAPH_PATH, TEXT_PATH)
    print("-"*50)
    print(f"Accuracy of footwear model: {acc:.2f}%")
