...
def main():
    print(f"Training big_category model:\n")
    DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
    DATA_PATH = f"./dataset/my_dataset/model1/improved/big_category/"
    MODEL_PATH = f"./classification_model/model1/model/big_category.pt"
    CONFMAT_PATH = f"./classification_model/model1/result/confmat/big_category_train.jpg"
    GRAPH_PATH = f"./classification_model/model1/result/graph/big_category_train.jpg"
    TEXT_PATH = f"./classification_model/model1/result/text/big_category_train.txt"
    acc = train_all_model(DEVICE, DATA_PATH, MODEL_PATH, CONFMAT_PATH, GRAPH_PATH, TEXT_PATH)
    print("-"*50)
    print(f"Accuracy of big_category model: {acc:.2f}%")
