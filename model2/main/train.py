...
DATA_PATH = "./dataset/my_dataset/model2/"
MODEL_PATH = "./classification_model/model2/train.pt"
...
def main():
    ...
    # Weighted Cross-Entropy Loss (optional, for imbalanced data)
    ...
    confmat_path = "./classification_model/model2/result/train_confmat.jpg"
    ...
    graph_path = "./classification_model/model2/result/train_graph.jpg"
